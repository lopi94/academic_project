...
public class Results extends HttpServlet implements Controler{
     ...
     /**
     * variable holds data form database
     */
    private List<pl.jkubieniec.model.Results<String,Integer>> inData = new ArrayList();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            inData.clear();
            inData = ResultDAO.getAllResults();
            ...
            while(i < inData.size()) {
                out.println("<tr>");
                out.println("<td>" + inData.get(i).getNick() + "</td> <td>" + inData.get(i).getWhichQuiz() + 
                        "</td> <td>" + inData.get(i).getScore() + "</td>\n");
                out.println("</tr>");
                i++;
            }
            out.println("</table>");            
